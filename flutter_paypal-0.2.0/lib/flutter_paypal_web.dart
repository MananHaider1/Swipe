...
import 'package:flutter_paypal/src/provider.dart';
...
class UsePaypal extends ConsumerStatefulWidget {
...
class UsePaypalState extends ConsumerState<UsePaypal>
    with WidgetsBindingObserver {
  late final WebViewController _controller;
  late PlatformWebViewController webController;
  String checkoutUrl = '';
  String navUrl = '';
  String executeUrl = '';
  String accessToken = '';
    ...
    try {
      ...
      if (getToken['token'] != null) {
        ...
        if (res["approvalUrl"] != null) {
          ...
          webController
              .loadRequest(LoadRequestParams(uri: Uri.parse(checkoutUrl)));
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      listenToUrlChanges(webController, ref);
    });
  }
