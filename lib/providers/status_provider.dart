...
final statusProviderProvider =
    ChangeNotifierProvider<StatusProvider>((ref) => StatusProvider());
...
class StatusProvider with ChangeNotifier {
  ...
  searchContactStatus(String currentuserphone, FutureGroup futureGroup,
      List<DeviceContactIdAndName> alljoinedUserPhoneStringAsInServer, {List<String>? following}) async {
    ...
    if (joinedUserPhoneStringAsInServer.isEmpty) {
      ...
      List<List<String>> chunks = Lamat.divideIntoChuncks(
...
// import 'package:lamatdating/v3/Services/Providers/SmartContactProviderWithLocalStoreData.dart';
// import 'package:lamatdating/v3/Utils/utils.dart';
// import 'package:flutter/foundation.dart';
// import 'package:flutter/material.dart';
