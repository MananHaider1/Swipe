...
import 'package:lamatdating/models/notification_model.dart' as notfi;
    ...
    return SubscriptionBuilder(builder: (context, isPremiumUser) {
      return SizedBox(
          ...
          child: Consumer(builder: (context, ref, child) {
            final filteredUsers =
                ref.watch(filteredOtherUsersProvider(ref)).value;
            ...
            return usersList.isEmpty
                ? Center(
                    child: HomePageNoUsersFoundWidget( user: currentUserProf!,
                        isPremium:
    ...
    return interactionProvider.when(
        data: (data) {
          ...
          return closestUsers.isEmpty
              ? Center(
                  child: HomePageNoUsersFoundWidget( user: currentUserProf,
                      isPremium: isPremiumUser || currentUserProf.isPremium!))
              : HomeBody(
                  prefs: prefs,
                  currentUserProf: currentUserProf,
                  users: filteredUsers,
        ...
        loading: () {
          return Center(
              child: NoItemFoundWidget(
                  text: LocaleKeys.loading.tr(), isSmall: true));
        }
        // : HomeBody(
        //     prefs: prefs,
        //     users: filteredUsers,
...
class _HomeBodyState extends ConsumerState<HomeBody> {
  ...
  void createInteractionNotification(
    ...
    final notfi.NotificationModel notificationModel = notfi.NotificationModel(
      id: id,
  ...
  void showMatchingDialog({
    ...
    await createConversation(matchModel).then((matchResult) async {
      ...
      if (matchResult) {
        ...
        final notfi.NotificationModel notificationModel =
            notfi.NotificationModel(
          id: id,
          phoneNumber: currentUser.phoneNumber,
  ...
  Widget build(BuildContext context) {
    ...
    return (_swipeItems.isEmpty)
        ? HomePageNoUsersFoundWidget(user: widget.currentUserProf,
            isPremium: widget.isPremiumUser || widget.currentUserProf.isPremium!)
        : Center(
            child: SizedBox(
                height: height,
                width: width,
                child: Stack(
                  children: [
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return UserCardWidget(
                          ...
                          onTapBoost: () async {
                            ...
                            if (widget.currentUserProf.isBoosted == false &&
                            ...
                            } else if (widget.currentUserProf.isBoosted == true) {
                              ...
                              showModalBottomSheet(
                                ...
                                isScrollControlled:
                                    true, builder: (context) => const SubscriptionWidget());
                                                                                                    },
                                                                                                  )))
                                                                                        ],
                                                                                      );
                    ...
                    Positioned(
                      top: (!kIsWeb) ? MediaQuery.of(context).padding.top : AppConstants.defaultNumericValue,
                      child: Container(
                          padding: const EdgeInsets.symmetric(
...
class HomePageNoUsersFoundWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    DataModel cachedModel = DataModel(user.phoneNumber);
...
class _ChangeRadiusFromHomePageWidgetState
  ...
  void initState() {
    ...
    _maxDistanceInKm = widget.isPremium
        ? AppConfig.initialMaximumDistanceInKM
        : AppConfig.initialDistanceInKM;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const NoItemFoundWidget(isSmall: true),
          Text.rich(
            TextSpan(
              children: [
                TextSpan(
          ...
          CustomButton(
            onPressed: () async {
              final UserAccountSettingsModel newSettingsModel =
                ...
                distanceInKm:
                    _isWorldWide ? 40000 : _distanceInKm.toInt().toDouble(),
              );
