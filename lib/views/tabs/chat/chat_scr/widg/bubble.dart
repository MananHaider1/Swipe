...
class Bubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg =
        isMe ? AppConstants.lamatCHATBUBBLEcolor : AppConstants.lamatWhite;
    final align = isMe ? CrossAxisAlignment.end : CrossAxisAlignment.start;
    dynamic icon = delivered is bool && delivered
        ? (seen ? Icons.done_all : Icons.done_all)
        : Icons.access_time;
    final color = isMe
        ? AppConstants.lamatBlack.withOpacity(0.5)
        : AppConstants.lamatBlack.withOpacity(0.5);
    ...
    if (isContinuing) {
      radius = BorderRadius.circular(AppConstants.defaultNumericValue);
