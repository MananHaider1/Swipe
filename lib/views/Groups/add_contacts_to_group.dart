// ignore_for_file: library_private_types_in_public_api, avoid_function_literals_in_foreach_calls, empty_catches
...
class AddContactsToGroup extends ConsumerStatefulWidget {
...
class _AddContactsToGroupState extends ConsumerState<AddContactsToGroup>
                    ...
                    actions: <Widget>[
                      _selectedList.isEmpty
                          ...
                          : IconButton(
                              ...
                              onPressed: widget.isAddingWhileCreatingGroup ==
                                      true
                                  ? () async {
                                      groupdesc.clear();
                                      groupname.clear();
                                                              ...
                                                              await FirebaseFirestore
                                                                ...
                                                                await FirebaseFirestore
                                                                  ...
                                                                  await FirebaseFirestore
                                                                    ...
                                                                    Lamat.toast(
                                                                        '${LocaleKeys.errorcreatinggroup.tr()} $err');
                                                                    debugPrint(
                                  ...
                                  : () async {
                                        ...
                                        await contactsProvider
                                          ...
                                          if (peerDoc.data()![
                                            ...
                                            if (peerDoc
                                                    ...
                                                    .length >
                                                0) {
                                              targetUserNotificationTokens.add(
                                                  peerDoc
                                                      .data()![Dbkeys
                                                          .notificationTokens]
                                                      .last);
                                      ...
                                      await FirebaseFirestore.instance
                                        ...
                                        await FirebaseFirestore.instance
                                          ...
                                          Lamat.toast(
                                            LocaleKeys.errorcreatinggroup.tr(),
                                          );
                                        });
                                      });
                                    },
